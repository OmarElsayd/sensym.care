...
class Real_Time_Sound_Graph:
    ...
    def record_audio(self):
        ...
        while True:
            data = stream.read(self.CHUNK)  # read a chunk of data
    ...
    def VoiceToText(self) -> None:
        ...
        with sr.Microphone() as source:  # use the default microphone as the audio source
            while True:
                ...
                r.pause_threshold = 0.001  # wait for the user to pause the recognizer
                r.energy_threshold = 5000  # consider recognize when audio energy is above the threshold
